...
def registration(request):
    if request.method=="POST":
        ...
        print(firstname, lastname, email, country, state, city, address, pin, phone, whatsapp, linkedin, insta, git, college, year, stream, team, teamnum, teamname, teammemname1,teammememail1, teammemname2, teammememail2, teammemname3, teammememail3)
        ins = Registration(firstname=firstname, lastname=lastname, email=email, country=country, state=state, city=city, address=address, pin=pin, phone=phone, whatsapp=whatsapp, linkedin=linkedin, insta=insta, git=git, college=college, year=year, stream=stream, team=team, teamnum=teamnum, teamname=teamname, teammemname1=teammemname1, teammememail1=teammememail1, teammemname2=teammemname2, teammememail2=teammememail2, teammemname3=teammemname3, teammememail3=teammememail3)   
        ins.save()
